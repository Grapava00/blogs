...
function ArrowButton({ goPrev, goNext, goNextArrow, goPrevArrow }) {
  return (
    <>
      <svg
        onClick={goPrev}
...
ArrowButton.propTypes = {
  goPrev: PropType.func.isRequired,
  goNext: PropType.func.isRequired,
  goNextArrow: PropType.bool.isRequired,
  goPrevArrow: PropType.bool.isRequired,
};
