...
function Create() {
  ...
  const handleSelect = (event) => {
    const selectedCategories = [...event.target.selectedOptions].map(
      (option) => option.id
    );

    setSelectedOptions([...selectedOptions, ...selectedCategories]);
  };
